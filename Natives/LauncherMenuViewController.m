...
- (void)viewDidLoad {
  ...
  [self.options addObject:
  (id)[LauncherMenuCustomItem
  title:localize(@“Account”, nil)
  imageName:@“person.circle” action:^{
  ...
  // Note: accountBtnItem is kept for the play button popover flow only
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
  ...
  // ── REMOVED: accountBtnItem no longer shown in nav bar ──
  // Account is now accessible via the sidebar Account menu entry
...
// ── NEW: Open Account screen as a full panel push ───────────────────────────
...
// ── Existing popover — kept for play button flow ─────────────────────────────
